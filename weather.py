    ...
    with col2:
        if 'rain' in description:
            ...
            st.image('data:image/jpeg;base64,', use_column_width=True)
             ...
             st.image('https://media.istockphoto.com/id/1441374609/photo/winter-scene-frozen-pine-branches-covered-with-a-snow-winter-in-the-woods.webp?b=1&s=612x612&w=0&k=20&c=tD3RzZ3p-T_whZzm9DVjHP-dDvIS1ujPMbMRpvXpXhc=', use_column_width=True)
        elif 'fog' in description:
             st.image('https://media.istockphoto.com/id/1439000190/photo/misty-mountain-landscape.webp?b=1&s=612x612&w=0&k=20&c=vA3LRH-1YsLIG2bv7qCdVrZvxGlLl-zCLIJD3GMH1-w=', use_column_width=True)
except IndexError:
    st.write('Invalid Location')
